...
```js
import fs from 'fs'
import parser from 'esx-iptv-playlist-parser'
...
If you find a bug or want to contribute to the code or documentation, you can help by submitting an [issue](https://github.com/psycodeliccircus/esx-iptv-playlist-parser/issues) or a [pull request](https://github.com/psycodeliccircus/esx-iptv-playlist-parser/pulls).
